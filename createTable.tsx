                ...
                <DialogContent className='flex flex-col gap-4'>
                    <div className='flex flex-col gap-1'>
                        ...
                        <input
                            ...
                            className='create-input w-full max-w-full bg-transparent border border-[FFFFFF60] h-10 p-2 rounded'
                    ...
                    <div className='flex flex-col gap-1'>
                        ...
                        <input
                            ...
                            className='create-input w-full max-w-full  bg-transparent border border-[FFFFFF60] h-10 p-2 rounded text-white'
